namespace xxdswinform.GapfillingDomain
{
    ...
    internal class G_three_1
    {
        private TestGenerateTools numberTools = new TestGenerateTools();
        private Random random = new Random();
        private XmlDocument xmlDocument = new XmlDocument();

        public void g_three_1Generate(NuGenEQML control1, string number)
        {
            this.xmlDocument.Load("GapfillingXML/g_three_1.xml");
            foreach (XmlNode node in this.xmlDocument.FirstChild.ChildNodes)
            {
                ...
                if (StudentModel.isReGeneration)
                {
                    ...
                    string path = "temp/generate/g_three_1.xml";
                ...
                string sXML = node.InnerText.Replace("#x#", number).Replace("#a#", num.ToString()).Replace("#d#", num2.ToString()).Replace("#g#", num3.ToString()).Replace("#j#", num4.ToString()).Replace("#b#", num5.ToString()).Replace("#e#", num6.ToString()).Replace("#h#", num7.ToString()).Replace("#k#", num8.ToString()).Replace("#c#", num12.ToString()).Replace("#f#", num13.ToString()).Replace("#i#", num14.ToString()).Replace("#l#", num15.ToString());
                control1.Size = new Size(550, 120);
